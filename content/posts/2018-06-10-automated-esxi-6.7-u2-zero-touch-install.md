...
aliases:
- "/post/scripted-esxi-6.7-install-to-usb/"
...
You can download a [free 30 day trial](https://www.vmware.com/go/get-free-esxi) of ESXi. However, I'll be using my [EVALExperience](https://www.vmug.com/evalexperience). For $180, EVALExperience provides 1 year of VMware licenses for personal use.
...
- Navigate to `https://xxx.xxx.xxx.xxx/ui/#/login` and login using `root` and your password set earlier (`r00tp@ssw0rd`).

## Conclusion

At this point you can modify the ks scripts [even further](https://docs.vmware.com/en/VMware-vSphere/6.7/com.vmware.esxi.upgrade.doc/GUID-61A14EBB-5CF3-43EE-87EF-DB8EC6D83698.html). You could also create duplicate copied USB sticks for multiple hosts.
